...
namespace MultiScreenshotCaptureNamespace
{
	...
	public class MultiScreenshotCapture : EditorWindow
	{
		...
		[MenuItem("Window/TakeSnapshoot %g")]
		public static void SetSnap()
        {
			MultiScreenshotCapture multiScreenshot = GetWindow<MultiScreenshotCapture>();
			multiScreenshot.TakeSnapshoot();
        }
